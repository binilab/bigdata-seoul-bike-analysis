...
| Matplotlib (Pandas 보조) | Spark 결과 CSV를 이용한 시각화 |
...
> 본문에서 언급한 겨울철 약 14.31배는 12·1·2월을 **합산한 기준**(370,180건 → 5,298,832건)이며, 위 표의 월별 개별 증가 배수(예: 1월 20.25배)와는 다른 값이다. 계절 합계 기준으로 보면 봄 10.81배, 여름 7.59배, 가을 4.74배, 겨울 14.31배로 겨울이 가장 크게 증가하였다.
...
월별로 보면 평균 이용시간은 5월에 약 22.7분으로 가장 길고, 12월과 1월에는 약 17.8~18.0분으로 가장 짧다. 날씨가 좋은 봄과 초여름에는 한 번에 조금 더 오래 타고, 겨울에는 짧게 타는 계절성이 나타난다.
